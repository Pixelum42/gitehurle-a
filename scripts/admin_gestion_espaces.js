let spacesRepertory= [
    ...
    "description" : "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ac elementum lorem. Donec ac metus vestibulum, luctus dolor ut, ullamcorper justo. Phasellus pharetra pellentesque nunc vel aliquam. Pellentesque et lacus dui. Phasellus vulputate urna ac elit rhoncus mattis. Vestibulum iaculis scelerisque sodales. Suspendisse iaculis, leo sit amet venenatis molestie, purus lorem dignissim massa, ac aliquet elit augue eu lorem. Aenean posuere ante elit, vel ornare velit suscipit vel. Etiam ullamcorper ac libero id maximus. Cras porta nibh vel volutpat egestas. In interdum est at lectus imperdiet, eget hendrerit metus feugiat. Nunc et ligula ut tellus sagittis gravida. Etiam ultricies, ligula id fermentum porta, justo odio luctus eros, quis fringilla tortor tellus sit amet leo. ",
    "prix" : "35"
    }
,
    { 
...
function generateMainAdminSpaceManagement(space){// arg take spaceName[i];
    ...
    innerNavGMASM0.className="conainer-fluid";
    ...
    for (let i = 0; i < spacesRepertory.length; i++) {
        ...
        dropdownNavSpacesLink0[i].textContent=spacesRepertory[i].name;
    ...
    innerDivGMASM5.value=spacesRepertory[space].name;
    innerDivGMASM3.append(innerDivGMASM4,innerDivGMASM5);
    let innerDivGMASM6;
    let innerDivGMASM8=[];
    for (let i = 0; i < spacesRepertory[space].url.length; i++) {
        ...
        innerDivGMASM7.addEventListener('click',()=>{
            spacesRepertory[space].url[i]=innerDivGMASM8[i].value;
        ...
        innerDivGMASM8[i].value=spacesRepertory[space].url[i];
        ...
        innerDivGMASMBin.addEventListener('click',()=>{
            spacesRepertory[space].url.splice(i,1);
            generateMainAdminSpaceManagement(space);
        });
    ...
    innerDivAddUrlBtn.addEventListener('click',()=>{
        spacesRepertory[space].url.push("");
        generateMainAdminSpaceManagement(space);
    })
    ...
    innerDivGMASM12.value=spacesRepertory[space].description;
    ...
    innerDivGMASM17.value=spacesRepertory[space].prix;
    ...
    innerDivGMASM20.addEventListener('click',()=>{
        spacesRepertory[space].name = innerDivGMASM5.value;
        for (let i = 0; i < spacesRepertory[space].url.length; i++) {
            spacesRepertory[space].url[i]= innerDivGMASM8[i].value;            
        }
        spacesRepertory[space].description = innerDivGMASM12.value;
        spacesRepertory[space].prix = innerDivGMASM17.value;
        generateMainAdminSpaceManagement(space);
    })
    ...
    for (let i = 0; i < spacesRepertory[space].url.length; i++) {
        ...
        innerDivGMASM24.src=spacesRepertory[space].url[i];
